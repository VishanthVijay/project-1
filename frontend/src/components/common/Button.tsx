...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary:
      "bg-indigo-600 hover:bg-indigo-500 text-white focus:ring-indigo-500 shadow-indigo-600/20",
    secondary:
      "bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 focus:ring-slate-500",
    danger:
      "bg-rose-600 hover:bg-rose-500 text-white focus:ring-rose-500 shadow-rose-600/20",
    ghost:
      "bg-transparent hover:bg-slate-800 text-slate-300 hover:text-white focus:ring-slate-600 shadow-none",
  };
